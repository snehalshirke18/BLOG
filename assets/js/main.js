$(function () {
    ...
    $(document).ready(function () {
        ...
        // Set the theme based on the saved value or default to light
        if (savedTheme === "dark") {
...
$(document).ready(function () {
    ...
    var swiper = new Swiper(
        ".tc-popular-categories-slider3 .swiper-container",
        {
            slidesPerView: 6,
            spaceBetween: 30,
            speed: 1000,
    ...
    // ------------ columnist slider8 -----------
    var swiper = new Swiper(
        ".tc-popular-posts-blog-slider9 .swiper-container",
        {
            // slidesPerView: 2,
            spaceBetween: 30,
            speed: 1000,
